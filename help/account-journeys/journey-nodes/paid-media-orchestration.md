...
description: Learn how to use a journey to move people into an external audience, which you can then push to any supported paid media destination in the AEP destination catalog.
